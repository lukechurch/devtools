...
class CommPortListener {
  CommPortListener(this.loggingController, this.name, {this.isError = false}) {
    print("CommPort init");

    IDGServer server = IDGServer(this.loggingController);
    server.start();
  }

  final IDGController loggingController;
  final String name;
  final bool isError;
}
