...
class StarWars extends RestfulAPI {
  ...
  static const Map<String, String> _friendlyNames = {
    starWarsFilms: 'https://swapi.dev/api/films/',
    starWarsPeople: 'https://swapi.dev/api/people/',
    starWarsPlanets: 'https://swapi.dev/api/planets/',
    starWarsSpecies: 'https://swapi.dev/api/species/',
    starWarsStarships: 'https://swapi.dev/api/starships/',
    starWarsVehicles: 'https://swapi.dev/api/vehicles/',
  };

  final String _activefriendlyName;
  final String _defaultUri;
